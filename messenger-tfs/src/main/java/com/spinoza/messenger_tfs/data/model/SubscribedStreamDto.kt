...
data class SubscribedStreamDto(
    @SerialName("audible_notifications") val audibleNotifications: Boolean?,
    ...
    @SerialName("desktop_notifications") val desktopNotifications: Boolean?,
    ...
    @SerialName("in_home_view") val inHomeView: Boolean,
    ...
    @SerialName("pin_to_top") val pinToTop: Boolean,
    ...
    @SerialName("stream_weekly_traffic") val streamWeeklyTraffic: Int?,
    @SerialName("wildcard_mentions_notify") val wildcardMentionsNotify: Boolean?,
)